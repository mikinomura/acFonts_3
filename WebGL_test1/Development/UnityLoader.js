...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'WebGL_test1.data';
    var REMOTE_PACKAGE_BASE = 'WebGL_test1.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 6174630;
      var PACKAGE_UUID = '5cb3714c-2f9e-41a0-82eb-449c3f32fe6d';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 17, 0, 0).open('GET', '/PlayerConnectionConfigFile');
    new DataRequest(17, 22841, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(22841, 39841, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(39841, 218497, 0, 0).open('GET', '/level0');
    new DataRequest(218497, 218516, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(218516, 224677, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(224677, 2687093, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(2687093, 4588905, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(4588905, 6086277, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(6086277, 6147005, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(6147005, 6174630, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_WebGL_test1.data');

    };
    Module['addRunDependency']('datafile_WebGL_test1.data');
